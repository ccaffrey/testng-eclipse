...
//      classMethods.put(types[i].getFullyQualifiedName(), EMPTY_ARRAY_PARAM);
  ...
  public static void launchMethodConfiguration(IJavaProject javaProject,
                                               IMethod imethod,
                                               String runMode, IProgressMonitor monitor) {
  ...
  public static void launchMethodConfiguration(IJavaProject javaProject,
                                               IMethod iMethod,
                                               String runMode,
                                               RunInfo runInfo, IProgressMonitor monitor) {
    launchMethodConfiguration(javaProject, iMethod.getDeclaringType(), iMethod, runMode, runInfo, monitor);
  }
